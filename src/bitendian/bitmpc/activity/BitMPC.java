...
public class BitMPC extends Activity
{
	...
	enum StatusIconStatus
	{
		PLAY, PAUSE, STOP, CONNECT
	};

	private static final String[] types =
	{ "Artist", "Album", "Title", "Track", "Name", "Genre", "Date", "Composer",
			"Performer", "Disk", "Filename", "AlbumArtist", "Any", "Query" };
	...
	private OnTouchListener vibration_listener = new OnTouchListener() {
		...
		{
			if (preferences.getBoolean(SettingsDialog.SETTING_VIBRATION, true)
					&& _event.getAction() == MotionEvent.ACTION_DOWN)
				vibrator.vibrate(50);
			return false;
		}
	};
	...
	public boolean onContextItemSelected(MenuItem _item)
	{
		...
		case R.id.playlistmenu_remove:
			handler.playlistRemove(((AdapterContextMenuInfo) _item
	...
	private void initTabs()
	{
		...
		tabhost.addTab(tabhost
				...
				.setIndicator(
						...
						getResources().getDrawable(
								R.drawable.tab_playlist_selector))
		...
		tabhost.addTab(tabhost
				...
				.setIndicator(
						...
						getResources().getDrawable(
								R.drawable.tab_browse_selector))
				.setContent(R.id.tab_browse));
		tabhost.addTab(tabhost
				.newTabSpec("search")
				.setIndicator(
		...
		tabhost.addTab(tabhost
				.newTabSpec("rss")
				.setIndicator(getString(R.string.tab_rss),
						getResources().getDrawable(R.drawable.tab_rss_selector))
				.setContent(R.id.tab_rss));
	...
	private void initButtonsPanel()
	{
		...
		FrameLayout slider = (FrameLayout) control
				.findViewById(R.id.sliding_slider);
	...
	private void initSearchSubsystem()
	{
		...
		findViewById(R.id.search_do).setOnClickListener(new OnClickListener() {
		...
		results.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View _arg1, int _arg2,
					long _arg3)
			{
				handler.searchAdd((int) _arg3);
			}
		});
		...
		((Spinner) findViewById(R.id.search_type))
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> _arg0,
							View _arg1, int _arg2, long _arg3)
					{
						search();
					}
	...
	private void initRSSSubsystem()
	{
		...
		findViewById(R.id.rss_add).setOnClickListener(new OnClickListener() {
			public void onClick(View _v)
			{
				new AddURLDialog(BitMPC.this).show();
			}
		});
	...
	private void initPlaylistSubsystem()
	{
		...
		playlist.addRemoveListener(new RemoveListener() {
			public void remove(int _position)
			{
				handler.playlistRemove(_position);
			}
		});
		playlist.addDragListener(new DragListener() {
			public void drag(int _position)
			{
				handler.playlistStartMove(_position);
			}
		});
		playlist.addDropListener(new DropListener() {
			public void drop(int _position)
			{
				handler.playlistEndMove(_position);
			}
		});
		...
		OnClickListener buttonsListener = new OnClickListener() {
			...
			public void onClick(View _v)
			{
				...
				case R.id.playlist_play:
					handler.play();
					break;
				case R.id.playlist_pause:
					handler.pause();
					break;
				case R.id.playlist_next:
					handler.next();
					break;
				case R.id.playlist_url:
					new PlayURLDialog(BitMPC.this).show();
					break;
				}
			}
		};
		control.findViewById(R.id.playlist_previous).setOnClickListener(
				buttonsListener);
		control.findViewById(R.id.playlist_previous).setOnTouchListener(
				vibration_listener);
		control.findViewById(R.id.playlist_stop).setOnClickListener(
				buttonsListener);
		control.findViewById(R.id.playlist_stop).setOnTouchListener(
				vibration_listener);
		control.findViewById(R.id.playlist_play).setOnClickListener(
				buttonsListener);
		control.findViewById(R.id.playlist_play).setOnTouchListener(
				vibration_listener);
		control.findViewById(R.id.playlist_pause).setOnClickListener(
				buttonsListener);
		control.findViewById(R.id.playlist_pause).setOnTouchListener(
				vibration_listener);
		control.findViewById(R.id.playlist_next).setOnClickListener(
				buttonsListener);
		control.findViewById(R.id.playlist_next).setOnTouchListener(
				vibration_listener);
		control.findViewById(R.id.playlist_url).setOnClickListener(
				buttonsListener);
		control.findViewById(R.id.playlist_url).setOnTouchListener(
				vibration_listener);

		// volume listener
		((SeekBar) control.findViewById(R.id.playlist_volume))
				.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {

					public void onStopTrackingTouch(SeekBar _seekBar)
					{
						handler.setVolume(_seekBar.getProgress());
					}
					...
					public void onProgressChanged(SeekBar _seekBar,
							int _progress, boolean _fromUser)
					{
					}
		...
		playlist.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> _arg0, View _arg1,
					int _arg2, long _arg3)
			{
				handler.playlistPlay((int) _arg3);
			}
		});

		// results.setOnTouchListener(vibration_listener);
		// seek bar listener
		((SeekBar) findViewById(R.id.playlist_seek))
				.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {

					public void onStopTrackingTouch(SeekBar _seekBar)
					{
						handler.seek(_seekBar.getProgress());
					}
		...
		// repeat
		findViewById(R.id.repeat_icon).setOnClickListener(
				new OnClickListener() {
		...
		findViewById(R.id.shuffle_icon).setOnClickListener(
				new OnClickListener() {
					public void onClick(View v)
					{
						handler.random();
		...
		findViewById(R.id.playlist_current).setOnClickListener(
				new OnClickListener() {
					public void onClick(View v)
					{
						playlist.setSelection(handler.getPlaylistAdapter()
								.getSelected());
					}
				});
		...
		image.setOnClickListener(new OnClickListener() {
			public void onClick(View v)
			{
				handler.magicButton(currentStatus);
			}
		});
	...
	private void initBrowseSubsystem()
	{
		...
		results.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View _arg1, int _arg2,
					long _arg3)
			{
				handler.browseAdd((int) _arg3);
			}
		});

		// results.setOnTouchListener(vibration_listener);
		// back button listener
		findViewById(R.id.browse_back).setOnClickListener(
				new OnClickListener() {
					public void onClick(View _v)
					{
						handler.browseBack();
			...
			ContextMenuInfo _info)
	{
		...
		if (_v.getId() == R.id.browse_results)
			new MenuInflater(this).inflate(R.menu.browse, _menu);
		if (_v == playlist)
			new MenuInflater(this).inflate(R.menu.playlist, _menu);
		if (_v.getId() == R.id.rss_sites)
	...
	void editHost(HostItem _host)
	{
		hostDialog.show(_host);
	}

	void showCreateHostDialog()
	{
		hostDialog.show();
	}
	...
	private void search()
	{
		...
		if (spinner.getSelectedItemPosition() != Spinner.INVALID_POSITION
			...
			handler.search(types[spinner.getSelectedItemPosition()], text
					.getText().toString().replace("\n", ""));
	}

	void toggleHostsDialogButton()
	{
		hostsDialog.updateToggle();
	}

	void raiseBrowseProgressDialog()
	{
		raiseProgressDialog(getString(R.string.progress_browsing));
	}

	void raiseSearchProgressDialog()
	{
		raiseProgressDialog(getString(R.string.progress_searching));
	}
	...
	void setCurrentText(String _text)
	{
		((TextView) findViewById(R.id.playlist_current)).setText(_text);
	}
	...
	void setBrowsePath(String _path)
	{
		((TextView) findViewById(R.id.browse_path)).setText(_path);
	}
